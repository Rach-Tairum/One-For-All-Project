...
CREATE TABLE SpotifyClone.conexao_user_art (
...
INSERT INTO SpotifyClone.artistas(nome, sobrenome) VALUES
('Walter', 'Phoenix'),
('Peter', 'Strong'),
('Lance', 'Day'),
('Freedie',	'Shannon'),
...
INSERT INTO SpotifyClone.musicas(musica, album_id, duracao_seg) VALUES
('Soul For Us', 1, 200),
...
INSERT INTO SpotifyClone.conexao_user_art(usuario_id, artista_id) VALUES
(1, 1),
(1, 4),
(1, 3),
(2, 1),
